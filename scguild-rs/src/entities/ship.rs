...
pub struct Ship {
    ...
    pub cargo: usize,
    pub crew: usize,
    pub weapon_crew: usize,
    pub operations_crew: usize,
    pub mass: f64,
    pub is_spaceship: bool,
    pub manufacturer: Manufacturer,
    pub damage_before_destruction: DamageBeforeDestruction,
    pub damage_before_detach: DamageBeforeDetach,
    pub flight_characteristics: FlightCharacteristics,
    pub propulsion: Propulsion,
    pub quantum_travel: QuantumTravel,
    pub pilot_hardpoints: Vec<Hardpoint>,
    pub manned_turrets: Vec<Turret>,
    pub remote_turrets: Vec<Turret>,
